...
import 'package:tezda_projects/provider/user_provider.dart';
...
import 'package:tezda_projects/utilities/constants.dart';
import 'package:tezda_projects/utilities/generate_route.dart';

import 'controller/preference_controller.dart';


ValueNotifier<bool> isJobseekerLoggedIn = ValueNotifier(false);
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(providers: [
      ...
      home:
     PreferenceController.sharedPreferences.getString(Constants.userToken) != null ?
      ItemList():
     LoginPage()
    ));
  }
